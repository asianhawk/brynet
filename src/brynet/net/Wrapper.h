...
namespace brynet { namespace net { namespace wrapper {
    ...
    public:
        ...
        void    asyncConnect() const
        {
            asyncConnect(getConnectOptions(), mConnectionOptions);
        }

        TcpConnection::Ptr    syncConnect() const
        {
            return syncConnect(getConnectOptions(), mConnectionOptions);
        }
    ...
    public:
        ...
        void    asyncConnect() const
        {
            ...
            BaseConnectionBuilder<HttpConnectionBuilder>::asyncConnect(getConnectOptions(), connectionOptions);
        }
